...
class Cyton {
  ...
  private final float scale_fac_accel_G_per_count = 1;//0.002 / ((float)pow(2, 4));  //assume set to +/4G, so 2 mG per digit (datasheet). Account for 4 bits unused
  ...
  /**
   * Used right before a channel setting command is sent to the  to convert
